...
% Based on Jake Gutierrez's resume
% License : MIT
%------------------------
...
\section{Certifications}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{AWS}{: Solutions Architect Associate, Developer Associate} \\
     \textbf{Microsoft}{: Azure Fundamentals, Power BI} \\
     \textbf{Other}{: CompTIA A+, ITIL Foundation}
    }}
 \end{itemize}
